...
export const roofingProjects: Project[] = [
  {
    src: "/images/gallery/01-sunset-crew.webp",
    alt: "Revive crew finishing a residential roof at sunset",
...
export const gcProjects: Project[] = [
  {
  ...
  },
  {
    ...
    caption: "Custom deck & pergola · sample",
  },
  {
